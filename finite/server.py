...
class EventStore(event_pb2_grpc.EventStoreServicer):
    ...
    def GetMachine(self, request, context):
        return event_pb2.Machine(schema=request.schema, initial=[], capacity=[], transitions={})

    def Dispatch(self, request, context):
        state = event_pb2.State(id="foo", schema="bar", state=[], head = "head", created=None, updated=None)
